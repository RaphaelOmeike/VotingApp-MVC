...
namespace VotingApp.Migrations
{
    ...
    [Migration("20240924205453_eleventh_migration")]
    partial class eleventh_migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VotingApp.Models.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("592a63e8-d169-4885-8613-38970a7fa663"),
                            Description = "represents all the courses",
                            IsDeleted = false,
                            Name = "all courses"
                        });
                });
            ...
            modelBuilder.Entity("VotingApp.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "72727393",
                            Description = "the super admin of this application",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "27239479",
                            Description = "the student who votes in this application",
                            Name = "Student"
                        });
                });
            ...
            modelBuilder.Entity("VotingApp.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df6eeb01-5bff-40b9-b8fd-8ec69003c7ab"),
                            Email = "admin@gmail.com",
                            IsDeleted = false,
                            PasswordHash = "$2a$11$I255d6eJ9Ua.6gRqXzOyAel/WSgEtD13cY1D7KK/dvC6vZmZ5s5TC",
                            RoleId = "72727393"
                        });
                });
            ...
            modelBuilder.Entity("VotingApp.Models.Entities.User", b =>
                {
                    b.HasOne("VotingApp.Models.Entities.Role", "Role")
                        .WithMany("Users")
